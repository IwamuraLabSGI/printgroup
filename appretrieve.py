...
def retrieveall(ID):
    ...
    Cyankey = appproc.detectFeatures(ID,1,"./templates/CyanIMG/" + str(ID) + ".jpg" )
    Magendakey = appproc.detectFeatures(ID,2,"./templates/MagendaIMG/" + str(ID) + ".jpg" )
    Yellowkey = appproc.detectFeatures(ID,3,"./templates/YellowIMG/" + str(ID) + ".jpg" )
